      ...
      <div className="w-full max-w-md animate-fade-in-up">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-8 backdrop-blur-sm">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-white/12 bg-white/[0.04] py-2.5 text-sm font-medium text-white/80 transition hover:border-white/25 hover:bg-white/[0.08] hover:text-white disabled:cursor-not-allowed disabled:opacity-60"
          >
            {googleLoading ? (
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center">
              <span className="bg-[#06121A] px-3 text-xs text-white/35">or sign in with email</span>
            </div>
          </div>
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <Link
                  ...
                  className="text-xs font-medium text-[#67E8F9] transition-colors hover:text-[#67E8F9]/80"
                >
                  Forgot password?
                </Link>
              </div>

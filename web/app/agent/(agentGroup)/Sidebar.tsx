...
const NAV_LINKS = [
  ...
  { href: '/agent/phones', label: 'Phones', icon: Smartphone },
  { href: '/agent/sales', label: 'Sales', icon: ShoppingBag },
  { href: '/agent/buyers', label: 'Buyers', icon: Users },
  { href: '/agent/sub-agents', label: 'Sub-Agents', icon: UserPlus },
  { href: '/agent/logs', label: 'Logs', icon: Activity },
...
export default function AgentSidebar({ user }: Props) {
    ...
    <div className="flex flex-col h-full">
      <div className="p-5 border-b" style={{ borderColor: 'hsl(var(--border))' }}>
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs truncate" style={{ color: 'hsl(var(--muted-foreground))' }}>Agent Portal</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-3 border-t" style={{ borderColor: 'hsl(var(--border))' }}>
        <div className="px-3 py-2 mb-2">
          <p className="text-sm font-medium truncate" style={{ color: 'hsl(var(--foreground))' }}>{user.name || 'Agent'}</p>

      ...
      <div className="flex items-center justify-between px-6 py-5 border-b border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-white/40 mt-0.5 uppercase tracking-wider">Superadmin</p>
          </div>
        </div>
        {onClose && (
          <button
    ...
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      <div className="flex flex-1 flex-col min-w-0 overflow-hidden">
        ...
        <header className="flex items-center gap-4 border-b border-white/10 bg-card px-4 py-3 lg:hidden">
          ...
          <span className="font-semibold text-white text-sm">MederBuy — Superadmin</span>
        </header>
